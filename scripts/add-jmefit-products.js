// Script to add JmeFit products to the database
...
async function addJmeFitProducts() {
  try {
    console.log('Adding JmeFit products to database...');
    ...
    if (deleteError) {
      console.error('Error clearing existing products:', deleteError.message);
      // Continue anyway
    } else {
